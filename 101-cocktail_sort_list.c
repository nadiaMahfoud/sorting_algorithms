...
/**
 * swap_ahead - Swap a node ahead in a listint_t.
...
/**
 * swap_behind - Swap a node behind in a listint_t.
 * @list: A pointer to the head of a doubly-linked list of integers.
 * @tail: A pointer to the tail of the doubly-linked list.
 * @shaker: A pointer to the current swapping node of
 * the cocktail sort algorithm.
...
/**
 * cocktail_sort - Sort a listint_t using the cocktail sort algorithm.
